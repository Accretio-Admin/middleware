...
const apiCall = async (method, url, data) => {
	const privateKeyPath = path.join(__dirname, 'generate cert', '10502200001.private.pem'); // Adjust the path to the private key file
	// Use path.join to create cross-platform file paths
